...
$page_title = "Employee Payout Hisotry";
$breadcrumb = "Employee Payout";
                            ...
                            <div class="card-body">
                                <div class="data-tables datatable-dark">
                                    <div style="display: flex; justify-content: flex-end;">
                                        <a href="create_employee_salary.php" class="btn btn-sm btn-info">Give Salary</a>
                                    </div>
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT es.id, e.FirstName, e.LastName, es.salary_in, es.month, es.balance, es.payout_date FROM employee_salary es JOIN employees e ON es.empId = e.id";
                                            $query = $dbh->prepare($sql);
                                            $query->execute();
