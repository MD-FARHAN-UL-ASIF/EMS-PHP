                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped table-bordered progress-table text-center">
                                            ...
                                            <tbody>
                                                <?php 
                                                $sql = "SELECT leaves.id as lid, employees.FirstName, employees.LastName, employees.EmpId, employees.id, leaves.LeaveType, leaves.PostingDate, leaves.Status 
                                                        FROM leaves 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="leave_details.php?leaveid=<?php echo htmlentities($result->lid); ?>" class="btn btn-secondary btn-sm"> View Details</a>
                                                    </td>
                                                </tr>
                                                <?php 
                                                    $cnt++;
