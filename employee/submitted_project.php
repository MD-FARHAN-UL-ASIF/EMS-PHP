                                ...
                                <div class="data-tables">
                                    <table id="dataTable" class="table table-hover progress-table text-center">
                                        ...
                                        <tbody>
                                            <?php
                                            $eid = $_SESSION['eid'];
                                            $sql = "SELECT id, title, description, starting_date, closing_date, submission_date, documents, status FROM project WHERE empId=:eid AND status=1";
